    ...
    <header className="flex h-20 items-center gap-8 border-b border-cerebro-border px-8">
      ...
      <div className="flex items-center gap-3">
        <div className="text-right">
          <p className="text-sm font-medium text-cerebro-ink">Wei Zhang</p>
          <p className="text-xs text-cerebro-muted">Admin</p>
        </div>
        <div
          className="flex h-9 w-9 items-center justify-center border border-cerebro-border bg-cerebro-bg-raised text-sm font-medium text-cerebro-accent-lightest"
          aria-hidden="true"
        >
          WZ
        </div>
